...
<%@ include file="/includes/header.jsp" %>
	...
	<section class="general-board">
            ...
            <div class="board-list">
                ...
                <c:if test="${empty generalSearchList }">
                 <script>
                 	alert("검색내용을 찾을 수 없습니다.");
                 	location.href ="/generalList.board?cpage=1";
                 </script>
                </c:if>
					                
                
                <c:forEach var="i" items="${generalSearchList}">
        ...
        <form action="/generalSearchList.board?cpage=1" method="get" id="frm">
        <div class="search">
